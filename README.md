...
```bash
curl -fsSL "https://github.com/Tonklaistonton/free-claude-code/blob/main/scripts/install.sh?raw=1" | sh
```

Windows PowerShell:

```powershell
irm "https://github.com/Tonklaistonton/free-claude-code/blob/main/scripts/install.ps1?raw=1" | iex
```
